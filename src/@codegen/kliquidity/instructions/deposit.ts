...
export type DepositInstructionData = { discriminator: ReadonlyUint8Array; tokenMaxA: bigint; tokenMaxB: bigint;  };

export type DepositInstructionDataArgs = { tokenMaxA: number | bigint; tokenMaxB: number | bigint;  };

export function getDepositInstructionDataEncoder(): FixedSizeEncoder<DepositInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['tokenMaxA', getU64Encoder()], ['tokenMaxB', getU64Encoder()]]), (value) => ({ ...value, discriminator: DEPOSIT_DISCRIMINATOR }));
}
