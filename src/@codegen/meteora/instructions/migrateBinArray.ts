...
return Object.freeze({ accounts: [getAccountMeta("lbPair", accounts.lbPair)], data: getMigrateBinArrayInstructionDataEncoder().encode({}), programAddress } as MigrateBinArrayInstruction<TProgramAddress, TAccountLbPair>);
}
