...
export const REMOVE_ALL_LIQUIDITY_DISCRIMINATOR = new Uint8Array([10, 51, 61, 35, 112, 105, 24, 85]);

export function getRemoveAllLiquidityDiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(REMOVE_ALL_LIQUIDITY_DISCRIMINATOR); }
...
export type RemoveAllLiquidityInstructionData = { discriminator: ReadonlyUint8Array;  };
...
export function getRemoveAllLiquidityInstructionDataEncoder(): FixedSizeEncoder<RemoveAllLiquidityInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]), (value) => ({ ...value, discriminator: REMOVE_ALL_LIQUIDITY_DISCRIMINATOR }));
}
...
export function getRemoveAllLiquidityInstructionDataCodec(): FixedSizeCodec<RemoveAllLiquidityInstructionDataArgs, RemoveAllLiquidityInstructionData> {
    return combineCodec(getRemoveAllLiquidityInstructionDataEncoder(), getRemoveAllLiquidityInstructionDataDecoder());
}
...
return Object.freeze({ accounts: [getAccountMeta(accounts.position), getAccountMeta(accounts.lbPair), getAccountMeta(accounts.binArrayBitmapExtension), getAccountMeta(accounts.userTokenX), getAccountMeta(accounts.userTokenY), getAccountMeta(accounts.reserveX), getAccountMeta(accounts.reserveY), getAccountMeta(accounts.tokenXMint), getAccountMeta(accounts.tokenYMint), getAccountMeta(accounts.binArrayLower), getAccountMeta(accounts.binArrayUpper), getAccountMeta(accounts.sender), getAccountMeta(accounts.tokenXProgram), getAccountMeta(accounts.tokenYProgram), getAccountMeta(accounts.eventAuthority), getAccountMeta(accounts.program)], data: getRemoveAllLiquidityInstructionDataEncoder().encode({}), programAddress } as RemoveAllLiquidityInstruction<TProgramAddress, TAccountPosition, TAccountLbPair, TAccountBinArrayBitmapExtension, TAccountUserTokenX, TAccountUserTokenY, TAccountReserveX, TAccountReserveY, TAccountTokenXMint, TAccountTokenYMint, TAccountBinArrayLower, TAccountBinArrayUpper, TAccountSender, TAccountTokenXProgram, TAccountTokenYProgram, TAccountEventAuthority, TAccountProgram>);
}

export type ParsedRemoveAllLiquidityInstruction<TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
export function parseRemoveAllLiquidityInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedRemoveAllLiquidityInstruction<TProgram, TAccountMetas> {
