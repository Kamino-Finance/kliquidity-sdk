...
import { combineCodec, fixDecoderSize, fixEncoderSize, getArrayDecoder, getArrayEncoder, getBytesDecoder, getBytesEncoder, getStructDecoder, getStructEncoder, transformEncoder, type AccountMeta, type AccountSignerMeta, type Address, type Codec, type Decoder, type Encoder, type Instruction, type InstructionWithAccounts, type InstructionWithData, type ReadonlyAccount, type ReadonlySignerAccount, type ReadonlyUint8Array, type TransactionSigner, type WritableAccount } from '@solana/kit';
import { LB_CLMM_PROGRAM_ADDRESS } from '../programs';
import { getAccountMetaFactory, type ResolvedAccount } from '../shared';
import { getBinLiquidityReductionDecoder, getBinLiquidityReductionEncoder, type BinLiquidityReduction, type BinLiquidityReductionArgs } from '../types';
...
export type RemoveLiquidityInstructionData = { discriminator: ReadonlyUint8Array; binLiquidityRemoval: Array<BinLiquidityReduction>;  };

export type RemoveLiquidityInstructionDataArgs = { binLiquidityRemoval: Array<BinLiquidityReductionArgs>;  };

export function getRemoveLiquidityInstructionDataEncoder(): Encoder<RemoveLiquidityInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['binLiquidityRemoval', getArrayEncoder(getBinLiquidityReductionEncoder())]]), (value) => ({ ...value, discriminator: REMOVE_LIQUIDITY_DISCRIMINATOR }));
}

export function getRemoveLiquidityInstructionDataDecoder(): Decoder<RemoveLiquidityInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['binLiquidityRemoval', getArrayDecoder(getBinLiquidityReductionDecoder())]]);
}
...
return Object.freeze({ accounts: [getAccountMeta(accounts.position), getAccountMeta(accounts.lbPair), getAccountMeta(accounts.binArrayBitmapExtension), getAccountMeta(accounts.userTokenX), getAccountMeta(accounts.userTokenY), getAccountMeta(accounts.reserveX), getAccountMeta(accounts.reserveY), getAccountMeta(accounts.tokenXMint), getAccountMeta(accounts.tokenYMint), getAccountMeta(accounts.binArrayLower), getAccountMeta(accounts.binArrayUpper), getAccountMeta(accounts.sender), getAccountMeta(accounts.tokenXProgram), getAccountMeta(accounts.tokenYProgram), getAccountMeta(accounts.eventAuthority), getAccountMeta(accounts.program)], data: getRemoveLiquidityInstructionDataEncoder().encode(args as RemoveLiquidityInstructionDataArgs), programAddress } as RemoveLiquidityInstruction<TProgramAddress, TAccountPosition, TAccountLbPair, TAccountBinArrayBitmapExtension, TAccountUserTokenX, TAccountUserTokenY, TAccountReserveX, TAccountReserveY, TAccountTokenXMint, TAccountTokenYMint, TAccountBinArrayLower, TAccountBinArrayUpper, TAccountSender, TAccountTokenXProgram, TAccountTokenYProgram, TAccountEventAuthority, TAccountProgram>);
}

export type ParsedRemoveLiquidityInstruction<TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
export function parseRemoveLiquidityInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedRemoveLiquidityInstruction<TProgram, TAccountMetas> {
