...
return Object.freeze({ accounts: [getAccountMeta("lbPair", accounts.lbPair), getAccountMeta("admin", accounts.admin)], data: getTogglePairStatusInstructionDataEncoder().encode({}), programAddress } as TogglePairStatusInstruction<TProgramAddress, TAccountLbPair, TAccountAdmin>);
}
