...
export type RemoveLiquidityByRangeInstructionData = { discriminator: ReadonlyUint8Array; fromBinId: number; toBinId: number; bpsToRemove: number;  };

export type RemoveLiquidityByRangeInstructionDataArgs = { fromBinId: number; toBinId: number; bpsToRemove: number;  };
...
export function getRemoveLiquidityByRangeInstructionDataEncoder(): FixedSizeEncoder<RemoveLiquidityByRangeInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['fromBinId', getI32Encoder()], ['toBinId', getI32Encoder()], ['bpsToRemove', getU16Encoder()]]), (value) => ({ ...value, discriminator: REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR }));
}

export function getRemoveLiquidityByRangeInstructionDataDecoder(): FixedSizeDecoder<RemoveLiquidityByRangeInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['fromBinId', getI32Decoder()], ['toBinId', getI32Decoder()], ['bpsToRemove', getU16Decoder()]]);
}

export function getRemoveLiquidityByRangeInstructionDataCodec(): FixedSizeCodec<RemoveLiquidityByRangeInstructionDataArgs, RemoveLiquidityByRangeInstructionData> {
    return combineCodec(getRemoveLiquidityByRangeInstructionDataEncoder(), getRemoveLiquidityByRangeInstructionDataDecoder());
}

export type RemoveLiquidityByRangeInput<TAccountPosition extends string = string, TAccountLbPair extends string = string, TAccountBinArrayBitmapExtension extends string = string, TAccountUserTokenX extends string = string, TAccountUserTokenY extends string = string, TAccountReserveX extends string = string, TAccountReserveY extends string = string, TAccountTokenXMint extends string = string, TAccountTokenYMint extends string = string, TAccountBinArrayLower extends string = string, TAccountBinArrayUpper extends string = string, TAccountSender extends string = string, TAccountTokenXProgram extends string = string, TAccountTokenYProgram extends string = string, TAccountEventAuthority extends string = string, TAccountProgram extends string = string> =  {
