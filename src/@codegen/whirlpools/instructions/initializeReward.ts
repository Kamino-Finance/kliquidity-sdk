...
export function getInitializeRewardInstructionDataEncoder(): FixedSizeEncoder<InitializeRewardInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['rewardIndex', getU8Encoder()]]), (value) => ({ ...value, discriminator: INITIALIZE_REWARD_DISCRIMINATOR }));
}
...
return Object.freeze({ accounts: [getAccountMeta("rewardAuthority", accounts.rewardAuthority), getAccountMeta("funder", accounts.funder), getAccountMeta("whirlpool", accounts.whirlpool), getAccountMeta("rewardMint", accounts.rewardMint), getAccountMeta("rewardVault", accounts.rewardVault), getAccountMeta("tokenProgram", accounts.tokenProgram), getAccountMeta("systemProgram", accounts.systemProgram), getAccountMeta("rent", accounts.rent)], data: getInitializeRewardInstructionDataEncoder().encode(args as InitializeRewardInstructionDataArgs), programAddress } as InitializeRewardInstruction<TProgramAddress, TAccountRewardAuthority, TAccountFunder, TAccountWhirlpool, TAccountRewardMint, TAccountRewardVault, TAccountTokenProgram, TAccountSystemProgram, TAccountRent>);
}

export type ParsedInitializeRewardInstruction<TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
