...
export type IncreaseLiquidityV2InstructionData = { discriminator: ReadonlyUint8Array; liquidityAmount: bigint; tokenMaxA: bigint; tokenMaxB: bigint; remainingAccountsInfo: Option<RemainingAccountsInfo>;  };

export type IncreaseLiquidityV2InstructionDataArgs = { liquidityAmount: number | bigint; tokenMaxA: number | bigint; tokenMaxB: number | bigint; remainingAccountsInfo: OptionOrNullable<RemainingAccountsInfoArgs>;  };

export function getIncreaseLiquidityV2InstructionDataEncoder(): Encoder<IncreaseLiquidityV2InstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['liquidityAmount', getU128Encoder()], ['tokenMaxA', getU64Encoder()], ['tokenMaxB', getU64Encoder()], ['remainingAccountsInfo', getOptionEncoder(getRemainingAccountsInfoEncoder())]]), (value) => ({ ...value, discriminator: INCREASE_LIQUIDITY_V2_DISCRIMINATOR }));
}

export function getIncreaseLiquidityV2InstructionDataDecoder(): Decoder<IncreaseLiquidityV2InstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['liquidityAmount', getU128Decoder()], ['tokenMaxA', getU64Decoder()], ['tokenMaxB', getU64Decoder()], ['remainingAccountsInfo', getOptionDecoder(getRemainingAccountsInfoDecoder())]]);
}
