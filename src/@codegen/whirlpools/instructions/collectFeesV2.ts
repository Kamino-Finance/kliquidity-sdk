...
export const COLLECT_FEES_V2_DISCRIMINATOR = new Uint8Array([207, 117, 95, 191, 229, 180, 226, 15]);

export function getCollectFeesV2DiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(COLLECT_FEES_V2_DISCRIMINATOR); }
...
export function parseCollectFeesV2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedCollectFeesV2Instruction<TProgram, TAccountMetas> {
