...
export function getSetConfigExtensionAuthorityInstructionDataCodec(): FixedSizeCodec<SetConfigExtensionAuthorityInstructionDataArgs, SetConfigExtensionAuthorityInstructionData> {
    return combineCodec(getSetConfigExtensionAuthorityInstructionDataEncoder(), getSetConfigExtensionAuthorityInstructionDataDecoder());
}

export type SetConfigExtensionAuthorityInput<TAccountWhirlpoolsConfig extends string = string, TAccountWhirlpoolsConfigExtension extends string = string, TAccountConfigExtensionAuthority extends string = string, TAccountNewConfigExtensionAuthority extends string = string> =  {
...
return Object.freeze({ accounts: [getAccountMeta("whirlpoolsConfig", accounts.whirlpoolsConfig), getAccountMeta("whirlpoolsConfigExtension", accounts.whirlpoolsConfigExtension), getAccountMeta("configExtensionAuthority", accounts.configExtensionAuthority), getAccountMeta("newConfigExtensionAuthority", accounts.newConfigExtensionAuthority)], data: getSetConfigExtensionAuthorityInstructionDataEncoder().encode({}), programAddress } as SetConfigExtensionAuthorityInstruction<TProgramAddress, TAccountWhirlpoolsConfig, TAccountWhirlpoolsConfigExtension, TAccountConfigExtensionAuthority, TAccountNewConfigExtensionAuthority>);
}

export type ParsedSetConfigExtensionAuthorityInstruction<TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
const getNextAccount = () => {
  ...
  return { programAddress: instruction.programAddress, accounts: { whirlpoolsConfig: getNextAccount(), whirlpoolsConfigExtension: getNextAccount(), configExtensionAuthority: getNextAccount(), newConfigExtensionAuthority: getNextAccount() }, data: getSetConfigExtensionAuthorityInstructionDataDecoder().decode(instruction.data) };
}