...
export function getInitializeTokenBadgeInstructionDataEncoder(): FixedSizeEncoder<InitializeTokenBadgeInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]), (value) => ({ ...value, discriminator: INITIALIZE_TOKEN_BADGE_DISCRIMINATOR }));
}
...
export function getInitializeTokenBadgeInstructionDataCodec(): FixedSizeCodec<InitializeTokenBadgeInstructionDataArgs, InitializeTokenBadgeInstructionData> {
