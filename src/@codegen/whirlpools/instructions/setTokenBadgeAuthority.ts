...
export const SET_TOKEN_BADGE_AUTHORITY_DISCRIMINATOR = new Uint8Array([207, 202, 4, 32, 205, 79, 13, 178]);

export function getSetTokenBadgeAuthorityDiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(SET_TOKEN_BADGE_AUTHORITY_DISCRIMINATOR); }
...
export type SetTokenBadgeAuthorityInstructionData = { discriminator: ReadonlyUint8Array;  };
...
export function getSetTokenBadgeAuthorityInstructionDataEncoder(): FixedSizeEncoder<SetTokenBadgeAuthorityInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]), (value) => ({ ...value, discriminator: SET_TOKEN_BADGE_AUTHORITY_DISCRIMINATOR }));
}
...
export function getSetTokenBadgeAuthorityInstructionDataCodec(): FixedSizeCodec<SetTokenBadgeAuthorityInstructionDataArgs, SetTokenBadgeAuthorityInstructionData> {
    return combineCodec(getSetTokenBadgeAuthorityInstructionDataEncoder(), getSetTokenBadgeAuthorityInstructionDataDecoder());
}
...
export function getSetTokenBadgeAuthorityInstruction<TAccountWhirlpoolsConfig extends string, TAccountWhirlpoolsConfigExtension extends string, TAccountConfigExtensionAuthority extends string, TAccountNewTokenBadgeAuthority extends string, TProgramAddress extends Address = typeof WHIRLPOOL_PROGRAM_ADDRESS>(input: SetTokenBadgeAuthorityInput<TAccountWhirlpoolsConfig, TAccountWhirlpoolsConfigExtension, TAccountConfigExtensionAuthority, TAccountNewTokenBadgeAuthority>, config?: { programAddress?: TProgramAddress } ): SetTokenBadgeAuthorityInstruction<TProgramAddress, TAccountWhirlpoolsConfig, TAccountWhirlpoolsConfigExtension, TAccountConfigExtensionAuthority, TAccountNewTokenBadgeAuthority> {
  // Program address.
const programAddress = config?.programAddress ?? WHIRLPOOL_PROGRAM_ADDRESS;

 // Original accounts.
const originalAccounts = { whirlpoolsConfig: { value: input.whirlpoolsConfig ?? null, isWritable: false }, whirlpoolsConfigExtension: { value: input.whirlpoolsConfigExtension ?? null, isWritable: true }, configExtensionAuthority: { value: input.configExtensionAuthority ?? null, isWritable: false }, newTokenBadgeAuthority: { value: input.newTokenBadgeAuthority ?? null, isWritable: false } }
...
return Object.freeze({ accounts: [getAccountMeta("whirlpoolsConfig", accounts.whirlpoolsConfig), getAccountMeta("whirlpoolsConfigExtension", accounts.whirlpoolsConfigExtension), getAccountMeta("configExtensionAuthority", accounts.configExtensionAuthority), getAccountMeta("newTokenBadgeAuthority", accounts.newTokenBadgeAuthority)], data: getSetTokenBadgeAuthorityInstructionDataEncoder().encode({}), programAddress } as SetTokenBadgeAuthorityInstruction<TProgramAddress, TAccountWhirlpoolsConfig, TAccountWhirlpoolsConfigExtension, TAccountConfigExtensionAuthority, TAccountNewTokenBadgeAuthority>);
}

export type ParsedSetTokenBadgeAuthorityInstruction<TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
export function parseSetTokenBadgeAuthorityInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedSetTokenBadgeAuthorityInstruction<TProgram, TAccountMetas> {
...
const getNextAccount = () => {
  ...
  return { programAddress: instruction.programAddress, accounts: { whirlpoolsConfig: getNextAccount(), whirlpoolsConfigExtension: getNextAccount(), configExtensionAuthority: getNextAccount(), newTokenBadgeAuthority: getNextAccount() }, data: getSetTokenBadgeAuthorityInstructionDataDecoder().decode(instruction.data) };
}