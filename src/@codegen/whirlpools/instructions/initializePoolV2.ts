...
export type InitializePoolV2InstructionData = { discriminator: ReadonlyUint8Array; tickSpacing: number; initialSqrtPrice: bigint;  };

export type InitializePoolV2InstructionDataArgs = { tickSpacing: number; initialSqrtPrice: number | bigint;  };

export function getInitializePoolV2InstructionDataEncoder(): FixedSizeEncoder<InitializePoolV2InstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['tickSpacing', getU16Encoder()], ['initialSqrtPrice', getU128Encoder()]]), (value) => ({ ...value, discriminator: INITIALIZE_POOL_V2_DISCRIMINATOR }));
}
...
export function getInitializePoolV2InstructionDataCodec(): FixedSizeCodec<InitializePoolV2InstructionDataArgs, InitializePoolV2InstructionData> {
    return combineCodec(getInitializePoolV2InstructionDataEncoder(), getInitializePoolV2InstructionDataDecoder());
}
