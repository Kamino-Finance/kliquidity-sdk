...
export function getDeletePositionBundleDiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(DELETE_POSITION_BUNDLE_DISCRIMINATOR); }
...
export type DeletePositionBundleInstructionData = { discriminator: ReadonlyUint8Array;  };
...
export function getDeletePositionBundleInstructionDataEncoder(): FixedSizeEncoder<DeletePositionBundleInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]), (value) => ({ ...value, discriminator: DELETE_POSITION_BUNDLE_DISCRIMINATOR }));
}
...
export function getDeletePositionBundleInstructionDataCodec(): FixedSizeCodec<DeletePositionBundleInstructionDataArgs, DeletePositionBundleInstructionData> {
    return combineCodec(getDeletePositionBundleInstructionDataEncoder(), getDeletePositionBundleInstructionDataDecoder());
}

export type DeletePositionBundleInput<TAccountPositionBundle extends string = string, TAccountPositionBundleMint extends string = string, TAccountPositionBundleTokenAccount extends string = string, TAccountPositionBundleOwner extends string = string, TAccountReceiver extends string = string, TAccountTokenProgram extends string = string> =  {
