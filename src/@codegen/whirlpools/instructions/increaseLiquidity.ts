...
export type IncreaseLiquidityInstructionData = { discriminator: ReadonlyUint8Array; liquidityAmount: bigint; tokenMaxA: bigint; tokenMaxB: bigint;  };

export type IncreaseLiquidityInstructionDataArgs = { liquidityAmount: number | bigint; tokenMaxA: number | bigint; tokenMaxB: number | bigint;  };

export function getIncreaseLiquidityInstructionDataEncoder(): FixedSizeEncoder<IncreaseLiquidityInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['liquidityAmount', getU128Encoder()], ['tokenMaxA', getU64Encoder()], ['tokenMaxB', getU64Encoder()]]), (value) => ({ ...value, discriminator: INCREASE_LIQUIDITY_DISCRIMINATOR }));
}

export function getIncreaseLiquidityInstructionDataDecoder(): FixedSizeDecoder<IncreaseLiquidityInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['liquidityAmount', getU128Decoder()], ['tokenMaxA', getU64Decoder()], ['tokenMaxB', getU64Decoder()]]);
}
