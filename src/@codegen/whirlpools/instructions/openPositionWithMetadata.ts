...
export function getOpenPositionWithMetadataDiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(OPEN_POSITION_WITH_METADATA_DISCRIMINATOR); }
...
export function getOpenPositionWithMetadataInstructionDataEncoder(): FixedSizeEncoder<OpenPositionWithMetadataInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['positionBump', getU8Encoder()], ['metadataBump', getU8Encoder()], ['tickLowerIndex', getI32Encoder()], ['tickUpperIndex', getI32Encoder()]]), (value) => ({ ...value, discriminator: OPEN_POSITION_WITH_METADATA_DISCRIMINATOR }));
}
...
export function getOpenPositionWithMetadataInstructionDataDecoder(): FixedSizeDecoder<OpenPositionWithMetadataInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['positionBump', getU8Decoder()], ['metadataBump', getU8Decoder()], ['tickLowerIndex', getI32Decoder()], ['tickUpperIndex', getI32Decoder()]]);
}

export function getOpenPositionWithMetadataInstructionDataCodec(): FixedSizeCodec<OpenPositionWithMetadataInstructionDataArgs, OpenPositionWithMetadataInstructionData> {
    return combineCodec(getOpenPositionWithMetadataInstructionDataEncoder(), getOpenPositionWithMetadataInstructionDataDecoder());
}

export type OpenPositionWithMetadataInput<TAccountFunder extends string = string, TAccountOwner extends string = string, TAccountPosition extends string = string, TAccountPositionMint extends string = string, TAccountPositionMetadataAccount extends string = string, TAccountPositionTokenAccount extends string = string, TAccountWhirlpool extends string = string, TAccountTokenProgram extends string = string, TAccountSystemProgram extends string = string, TAccountRent extends string = string, TAccountAssociatedTokenProgram extends string = string, TAccountMetadataProgram extends string = string, TAccountMetadataUpdateAuth extends string = string> =  {
