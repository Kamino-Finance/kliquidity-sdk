...
export const TWO_HOP_SWAP_V2_DISCRIMINATOR = new Uint8Array([186, 143, 209, 29, 254, 2, 194, 117]);

export function getTwoHopSwapV2DiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(TWO_HOP_SWAP_V2_DISCRIMINATOR); }
...
export function getTwoHopSwapV2InstructionDataDecoder(): Decoder<TwoHopSwapV2InstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['amount', getU64Decoder()], ['otherAmountThreshold', getU64Decoder()], ['amountSpecifiedIsInput', getBooleanDecoder()], ['aToBOne', getBooleanDecoder()], ['aToBTwo', getBooleanDecoder()], ['sqrtPriceLimitOne', getU128Decoder()], ['sqrtPriceLimitTwo', getU128Decoder()], ['remainingAccountsInfo', getOptionDecoder(getRemainingAccountsInfoDecoder())]]);
}

export function getTwoHopSwapV2InstructionDataCodec(): Codec<TwoHopSwapV2InstructionDataArgs, TwoHopSwapV2InstructionData> {
    return combineCodec(getTwoHopSwapV2InstructionDataEncoder(), getTwoHopSwapV2InstructionDataDecoder());
}
...
export function parseTwoHopSwapV2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedTwoHopSwapV2Instruction<TProgram, TAccountMetas> {
