...
export type DecreaseLiquidityV2InstructionData = { discriminator: ReadonlyUint8Array; liquidityAmount: bigint; tokenMinA: bigint; tokenMinB: bigint; remainingAccountsInfo: Option<RemainingAccountsInfo>;  };

export type DecreaseLiquidityV2InstructionDataArgs = { liquidityAmount: number | bigint; tokenMinA: number | bigint; tokenMinB: number | bigint; remainingAccountsInfo: OptionOrNullable<RemainingAccountsInfoArgs>;  };

export function getDecreaseLiquidityV2InstructionDataEncoder(): Encoder<DecreaseLiquidityV2InstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['liquidityAmount', getU128Encoder()], ['tokenMinA', getU64Encoder()], ['tokenMinB', getU64Encoder()], ['remainingAccountsInfo', getOptionEncoder(getRemainingAccountsInfoEncoder())]]), (value) => ({ ...value, discriminator: DECREASE_LIQUIDITY_V2_DISCRIMINATOR }));
}

export function getDecreaseLiquidityV2InstructionDataDecoder(): Decoder<DecreaseLiquidityV2InstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['liquidityAmount', getU128Decoder()], ['tokenMinA', getU64Decoder()], ['tokenMinB', getU64Decoder()], ['remainingAccountsInfo', getOptionDecoder(getRemainingAccountsInfoDecoder())]]);
}

export function getDecreaseLiquidityV2InstructionDataCodec(): Codec<DecreaseLiquidityV2InstructionDataArgs, DecreaseLiquidityV2InstructionData> {
...
return Object.freeze({ accounts: [getAccountMeta(accounts.whirlpool), getAccountMeta(accounts.tokenProgramA), getAccountMeta(accounts.tokenProgramB), getAccountMeta(accounts.memoProgram), getAccountMeta(accounts.positionAuthority), getAccountMeta(accounts.position), getAccountMeta(accounts.positionTokenAccount), getAccountMeta(accounts.tokenMintA), getAccountMeta(accounts.tokenMintB), getAccountMeta(accounts.tokenOwnerAccountA), getAccountMeta(accounts.tokenOwnerAccountB), getAccountMeta(accounts.tokenVaultA), getAccountMeta(accounts.tokenVaultB), getAccountMeta(accounts.tickArrayLower), getAccountMeta(accounts.tickArrayUpper)], data: getDecreaseLiquidityV2InstructionDataEncoder().encode(args as DecreaseLiquidityV2InstructionDataArgs), programAddress } as DecreaseLiquidityV2Instruction<TProgramAddress, TAccountWhirlpool, TAccountTokenProgramA, TAccountTokenProgramB, TAccountMemoProgram, TAccountPositionAuthority, TAccountPosition, TAccountPositionTokenAccount, TAccountTokenMintA, TAccountTokenMintB, TAccountTokenOwnerAccountA, TAccountTokenOwnerAccountB, TAccountTokenVaultA, TAccountTokenVaultB, TAccountTickArrayLower, TAccountTickArrayUpper>);
}

export type ParsedDecreaseLiquidityV2Instruction<TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
