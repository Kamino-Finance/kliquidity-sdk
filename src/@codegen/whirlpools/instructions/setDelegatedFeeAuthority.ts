...
export interface SetDelegatedFeeAuthorityAccounts {
  whirlpoolsConfig: Address
  adaptiveFeeTier: Address
  feeAuthority: TransactionSigner
  newDelegatedFeeAuthority: Address
}
 ...
 */
export function setDelegatedFeeAuthority(
  accounts: SetDelegatedFeeAuthorityAccounts,
  ...
  const keys: Array<IAccountMeta | IAccountSignerMeta> = [
    ...
    { address: accounts.newDelegatedFeeAuthority, role: 0 },
  ]
  const identifier = Buffer.from([193, 234, 231, 147, 138, 57, 3, 122])
