...
export function isWhirlpoolError<TProgramErrorCode extends WhirlpoolError>(
  ...
  return isProgramError<TProgramErrorCode>(error, transactionMessage, WHIRLPOOL_PROGRAM_ADDRESS, code);
}