...
export const COLLECT_FUND_FEE_DISCRIMINATOR = new Uint8Array([167, 138, 78, 149, 223, 194, 6, 126]);

export function getCollectFundFeeDiscriminatorBytes() { return fixEncoderSize(getBytesEncoder(), 8).encode(COLLECT_FUND_FEE_DISCRIMINATOR); }
...
export type CollectFundFeeInstructionData = { discriminator: ReadonlyUint8Array; amount0Requested: bigint; amount1Requested: bigint;  };

export type CollectFundFeeInstructionDataArgs = { amount0Requested: number | bigint; amount1Requested: number | bigint;  };

export function getCollectFundFeeInstructionDataEncoder(): FixedSizeEncoder<CollectFundFeeInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['amount0Requested', getU64Encoder()], ['amount1Requested', getU64Encoder()]]), (value) => ({ ...value, discriminator: COLLECT_FUND_FEE_DISCRIMINATOR }));
}
...
export function getCollectFundFeeInstructionDataCodec(): FixedSizeCodec<CollectFundFeeInstructionDataArgs, CollectFundFeeInstructionData> {
...
export function parseCollectFundFeeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedCollectFundFeeInstruction<TProgram, TAccountMetas> {
