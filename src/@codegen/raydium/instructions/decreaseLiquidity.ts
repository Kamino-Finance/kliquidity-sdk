...
export type DecreaseLiquidityInstructionData = { discriminator: ReadonlyUint8Array; liquidity: bigint; amount0Min: bigint; amount1Min: bigint;  };

export type DecreaseLiquidityInstructionDataArgs = { liquidity: number | bigint; amount0Min: number | bigint; amount1Min: number | bigint;  };

export function getDecreaseLiquidityInstructionDataEncoder(): FixedSizeEncoder<DecreaseLiquidityInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['liquidity', getU128Encoder()], ['amount0Min', getU64Encoder()], ['amount1Min', getU64Encoder()]]), (value) => ({ ...value, discriminator: DECREASE_LIQUIDITY_DISCRIMINATOR }));
}
